...
// ControllerDoc.cpp: CControllerDoc 类的实现
//
...
// CControllerDoc 构造/析构

CControllerDoc::CControllerDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CControllerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CControllerDoc::InitializeSearchContent()
{
...
void CControllerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
